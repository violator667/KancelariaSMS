...
@section('content_header')
    <h1><i class="fas faw fa-comment-medical"></i> Dodaj komunikat dla klientów.</h1>
@stop
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="card card-warning">
                <div class="card-header">
                    <h3 class="card-title"><i class="fas faw fa-user-tie"></i> Dodaj komunikat</h3>
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form method="POST" action="/panel/infos/add">
                        @csrf
                        <div class="form-group">
                            <label for="infoContent">Treść komunikatu:</label>
                            <textarea id="infoContent" class="form-control @error('infocontent') is-invalid @enderror" name="infocontent"  rows="5" cols="60" placeholder="np. Szanowni klienci w dniu 30.05.2022 kancelaria jest nieczynna." maxlength="100">{{ old('content') }}</textarea>
                            @error('infocontent')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('expires_at') is-invalid @enderror" id="infoDate" name="expires_at" placeholder="RRRR-MM-DD" value="{{ old('expires_at') }}" data-inputmask="'mask': ['9999-99-99']" data-mask="" required>
                            @error('expires_at')
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-sm btn-warning">Dodaj komunikat</button>
                    </form>
                </div>
                <!-- /.card-footer -->
            </div>
